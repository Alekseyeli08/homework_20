...
from blog.views import BlogCreateView, BlogListView, BlogDetailView, BlogUpdateView, BlogDeleteView, is_published, Blog2ListView
...
urlpatterns = [
    ...
    path('not_published', Blog2ListView.as_view(), name='blog_list2'),
